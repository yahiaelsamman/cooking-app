...
public enum SampleRecipes {
    ...
    public static let avocadoToast = Recipe(
        ...
        servings: 1,
        soloSteps: [
            RecipeStep(order: 0, instruction: "Toast the bread until golden and crisp.", assignee: .solo, imageSystemName: "flame.fill", stepImageName: "recipe-step-avocado-toast-0"),
            RecipeStep(order: 1, instruction: "Halve and pit the avocado.", assignee: .solo, imageSystemName: "scissors", stepImageName: "recipe-step-avocado-toast-1"),
            RecipeStep(order: 2, instruction: "Scoop the avocado into a bowl.", assignee: .solo, imageSystemName: "basket.fill", stepImageName: "recipe-step-avocado-toast-2"),
            RecipeStep(order: 3, instruction: "Mash with a squeeze of lemon juice and a pinch of salt.", assignee: .solo, imageSystemName: "arrow.triangle.2.circlepath", stepImageName: "recipe-step-avocado-toast-3"),
            RecipeStep(order: 4, instruction: "Heat a small non-stick pan with a little oil over medium heat.", assignee: .solo, imageSystemName: "flame.fill", stepImageName: "recipe-step-avocado-toast-4"),
    ...
    public static let grilledCheese = Recipe(
        ...
        servings: 1,
        soloSteps: [
            RecipeStep(order: 0, instruction: "Butter one side of each bread slice.", assignee: .solo, imageSystemName: "basket.fill", stepImageName: "recipe-step-grilled-cheese-0"),
            RecipeStep(order: 1, instruction: "Heat a skillet over medium-low heat.", assignee: .solo, imageSystemName: "flame.fill", stepImageName: "recipe-step-grilled-cheese-1"),
            RecipeStep(order: 2, instruction: "Place one slice butter-side down in the skillet.", assignee: .solo, imageSystemName: "drop.fill", stepImageName: "recipe-step-grilled-cheese-2"),
            RecipeStep(order: 3, instruction: "Layer the cheese slices on top.", assignee: .solo, imageSystemName: "basket.fill", stepImageName: "recipe-step-grilled-cheese-3"),
            RecipeStep(order: 4, instruction: "Top with the second slice, butter-side up.", assignee: .solo, imageSystemName: "arrow.triangle.2.circlepath", stepImageName: "recipe-step-grilled-cheese-4"),
            RecipeStep(order: 5, instruction: "Cook until the bottom is golden brown.", assignee: .solo, timerSeconds: 180, imageSystemName: "timer", stepImageName: "recipe-step-grilled-cheese-5"),
            RecipeStep(order: 6, instruction: "Flip carefully and cook the other side until golden and the cheese has melted.", assignee: .solo, timerSeconds: 180, imageSystemName: "timer", stepImageName: "recipe-step-grilled-cheese-6"),
            RecipeStep(order: 7, instruction: "Remove from the pan and let it rest for a minute before cutting.", assignee: .solo, timerSeconds: 60, imageSystemName: "clock.fill", stepImageName: "recipe-step-grilled-cheese-7"),
            RecipeStep(order: 8, instruction: "Slice in half and serve.", assignee: .solo, imageSystemName: "fork.knife", stepImageName: "recipe-step-grilled-cheese-8")
        ],
